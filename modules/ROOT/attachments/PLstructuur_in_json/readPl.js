...
function displayPL(isMooi) {
  ...
  gewijzigdePL.c01[0][0].e0213 = "later toegevoegd element!";
  if (isMooi)  {
  ...
  naamKind2.textContent = gewijzigdePL.c09[1][0].e0210;
  stapels12.textContent = gewijzigdePL.c12.length;
  voornamen.textContent = gewijzigdePL.c01[0][0].e0210;

  aanschrijfnaam.textContent = getAanschrijfnaam(
    gewijzigdePL.c01[0][0].e0210,
    gewijzigdePL.c01[0][0].e0240,
    gewijzigdePL.c01[0][0].e0410
  );
