...
Om de transitie naar de nieuwe JSON-structuur te bespoedigen, kun je gebruik maken van conversie endpoint welke berichten kan converteren tussen 'oud' en 'nieuw' formaat.
