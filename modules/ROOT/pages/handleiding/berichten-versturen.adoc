...
[CAUTION]
====
De combinatie van `verzender` + `ontvanger` + `berichtId` dient conform het {lo-naam-voluit} ({lo-naam-afgekort}} uniek te zijn.
...
Lees meer hierover in het {lo-naam-afgekort}: https://developer.rvig.nl/lo-brp/LO-BRP/#_berichtenafhandelingssysteem[window=_blank]
====
